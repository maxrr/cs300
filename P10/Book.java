...
public class Book {
  ...
  /**
   * Override of Object's equal method - two books are the same only if ALL of their attributes have
   * identical values
   * 
   * @param b the book to compare this book to
   * @return whether this book is equal to the book supplied as a parameter
   */
  @Override
  public boolean equals(Object b) {
    ...
    return (this.authorLastname.equals(bk.authorLastname)
        && this.authorFirstname.equals(bk.authorFirstname) && this.title.equals(bk.title)
        && this.pageCount == bk.pageCount);
  }
